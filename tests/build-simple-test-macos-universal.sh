...
$CXX -target x86_64-apple-macos13 -arch x86_64 \
     $COMMON_FLAGS $LINK_FLAGS simple-test.cpp -o "$OUTPUT_X86"
$CXX -target arm64-apple-macos13 -arch arm64 \
     $COMMON_FLAGS $LINK_FLAGS simple-test.cpp -o "$OUTPUT_ARM"
