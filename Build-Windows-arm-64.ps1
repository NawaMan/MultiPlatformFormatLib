...
# Rename lib directory to lib-windows-arm-64
Rename-Item -Path "$TargetDir\lib" -NewName "lib-windows-arm-64" -Force

# Directory has been renamed, no need to remove it
